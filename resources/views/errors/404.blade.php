...
<head>
    <meta charset="UTF-8">
    <title>404 - cтраница не найдена</title>
</head>
<style>
a{
...
<body>
	...
	<div  class="error">
		...
		<div class="page-ms">
			<p class="page-msg"> Ой, страница которую вы ищете не найдена </p>
			<button class="go-back"><a href="{{ url()->previous() }}">Вернуться</a></button>
		</div>
</div>
	</div>
