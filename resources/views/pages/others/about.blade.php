...
@section('description', 'МаксПром – это крупнейший в России интернет-магазин материалов. 
Мы собрали в одном месте все, что может понадобиться для Вас!')
@section('keywords', 'МаксПром, интернет-магазин материалов, для оптовых покупателей')


@section("canonical", url("/about.php"))
@section('content')
        ...
        <div class="about-us__block about-us__text">
            <div class="about-us__content">
                ...
                <p class="about-us__text-desc">
                    ...
                    <a href="mailto:makspromi@yandex.ru">makspromi@yandex.ru</a>
