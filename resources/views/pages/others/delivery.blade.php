...
@section('description', 'На терминал транспортных компаний передаем на следующий день 
после оформления (бесплатная доставка до терминалов «ПЭК» и «СДЭК»). Самовывоз возможен после подтверждения заказа')
@section('keywords', 'Доставка, стоимость доставки, срок доставки, траснпортными компаниями,
самовывоз')

@section("canonical", url("/delivery.php"))
