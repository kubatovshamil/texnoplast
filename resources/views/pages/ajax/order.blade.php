<div class="box-modal individual" id="Modal">
    ...
    <form action="#" class="individual-order">
        ...
        <div class="form-group">
            <input type="text" class="individual-order__inp" placeholder="Телефон">
        </div>

        <div class="form-group">
            <textarea class="individual-order__inp" name="note" id="" cols="40" rows="30" placeholder="Описание"></textarea>
        </div>
...
<script>
    $($(document).find('input')[6]).mask("+7 (999) 999-99-99");
</script>
